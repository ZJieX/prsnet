from model.backbones import PRSNetV2
import torch
...
parser.add_argument('--model_path', default="weights/V2checkpoint-90.pth", help='model with trained')

parser.add_argument('--input_size', default=(256, 128), type=int,
                    help='images input size')
parser.add_argument('--mask_ratio', default=0.75, type=float,
                        help='Masking ratio (percentage of removed patches).')
parser.add_argument('--data_path', default='D://PyCharm/xiaozhijie/su-reid/old_2022.9.18_rps/dataset_test/test/', type=str,
                    help='dataset path')
...
if __name__ == "__main__":
    ...
    models = RPSNetV2.__dict__[args.model](weights=args.weights)
    models.to(device)
