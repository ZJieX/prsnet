...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--test_dir", default="../../centroid/inference_datasets/msmt17/bounding_box_test/",
        help="test set paths in the dataset", type=str
    )
    parser.add_argument(
    ...
    val_loader = make_inference_data_loader(cfg, args.test_dir, dataset_type)
    if len(val_loader) == 0:
