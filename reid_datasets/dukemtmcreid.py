...
class DukeMTMCreID(ReidBaseDataModule):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, 'dukemtmc/bounding_box_train')
        self.query_dir = osp.join(self.dataset_dir, 'dukemtmc/query')
        self.gallery_dir = osp.join(self.dataset_dir, 'dukemtmc/bounding_box_test')
